function foc_data = focus_Aline(t,signal,foci_rx,elempos,tx_center,dc,speed_of_sound)
%
% FOCUS_ALINE - Focuses the RF data at desired locations (along assumed A-line)
%
